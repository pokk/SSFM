...
import taiwan.no1.app.ssfm.models.usecases.GetArtistTopAlbumsCase.RequestValue

/**
 * @author  jieyi
 * @since   10/11/17
 */
class GetArtistTopAlbumsCase(repository: IDataStore) : BaseUsecase<ArtistTopAlbumEntity, RequestValue>(repository) {
