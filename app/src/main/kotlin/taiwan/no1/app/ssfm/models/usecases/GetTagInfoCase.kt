...
import taiwan.no1.app.ssfm.models.usecases.GetTagInfoCase.RequestValue

/**
 * @author  jieyi
 * @since   11/5/17
 */
class GetTagInfoCase(repository: IDataStore) : BaseUsecase<TagEntity, RequestValue>(repository) {
