...
public class RadioTrack implements Serializable {
    ...
    public RadioTrack(String locationUrl, String title, String identifier, String album, String creator,
                      String duration, String imageUrl, String trackAuth, Boolean loved, String[] context) {
