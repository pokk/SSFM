 ...
 * @since   8/20/17
 */
class SearchIndexFragmentViewModel(private val topArtistsUsecase: BaseUsecase<TopArtistEntity, GetTopArtistsCase.RequestValue>,
    ...
    fun fetchTrackList(page: Int = 1,
                       limit: Int = 20,
                       callback: (List<TrackEntity.Track>, total: Int) -> Unit) =
