...
import no1.taiwan.devrapid.com.lastfm.api.ImageUrl;
import no1.taiwan.devrapid.com.lastfm.api.Venue;
    ...
    public Event build(Node eventNode) {
        ...
        if (ticketsNode != null) {
            ...
            for (Node ticket : ticketNodes) {
                ticketUrls.put(ticket.getAttributes().getNamedItem("supplier").getNodeValue(),
                               ticket.getFirstChild().getNodeValue());
            }
        }
