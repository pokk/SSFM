...
import taiwan.no1.app.ssfm.models.usecases.v2.GetSongListCase.RequestValue

/**
 * @author  jieyi
 * @since   11/21/17
 */
class GetSongListCase(repository: IDataStore) : BaseUsecase<SongListEntity, RequestValue>(repository) {
