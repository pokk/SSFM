...
import taiwan.no1.app.ssfm.models.usecases.GetDetailMusicCase.RequestValue
 ...
 * @since   8/14/17
 */
class GetDetailMusicCase(repository: IDataStore) : BaseUsecase<DetailMusicEntity, RequestValue>(repository) {
