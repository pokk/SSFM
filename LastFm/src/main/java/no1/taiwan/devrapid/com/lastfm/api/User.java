...
public class User implements Serializable {
    ...
    public User(String name, String realname, String url, ImageUrl[] images, Locale country, String age, Gender gender,
                String playcount, String subscriber, Date joindate, Track recentTrack) {
        this.name = name;
