...
import taiwan.no1.app.ssfm.models.usecases.RemoveKeywordHistoriesUsecase.RequestValue
 ...
 * @since   8/14/17
 */
class RemoveKeywordHistoriesUsecase(repository: IDataStore) : BaseUsecase<Boolean, RequestValue>(repository) {
