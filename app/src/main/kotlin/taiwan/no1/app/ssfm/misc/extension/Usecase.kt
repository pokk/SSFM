...
fun <T, V : RequestValues, E> LifecycleProvider<E>.compose(usecase: BaseUsecase<T, V>, parameter: V) =
    usecase.execute(parameter, this)

fun <T, V : RequestValues, E> LifecycleProvider<E>.compose(usecase: BaseUsecase<T, V>) =
