...
import taiwan.no1.app.ssfm.models.usecases.GetTagTopTracksUsecase.RequestValue

/**
 * @author  jieyi
 * @since   10/26/17
 */
class GetTagTopTracksUsecase(repository: IDataStore) : BaseUsecase<TopTrackEntity, RequestValue>(repository) {
