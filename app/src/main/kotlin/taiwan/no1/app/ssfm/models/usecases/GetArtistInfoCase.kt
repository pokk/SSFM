...
import taiwan.no1.app.ssfm.models.usecases.GetArtistInfoCase.RequestValue

/**
 * @author  jieyi
 * @since   10/11/17
 */
class GetArtistInfoCase(repository: IDataStore) : BaseUsecase<ArtistEntity, RequestValue>(repository) {
