...
public class Track implements Serializable {
    ...
    public Track(String id, String name, String mbid, String url, String duration, String streamable, String listeners,
                 String playcount, Artist artist, Album album, ImageUrl[] images, String date, String nowPlaying) {
        this.id = id;
        this.name = name;
        this.mbid = mbid;
        this.url = url;
