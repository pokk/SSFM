...
import taiwan.no1.app.ssfm.models.usecases.GetTagTopAlbumsUsecase.RequestValue

/**
 * @author  jieyi
 * @since   10/26/17
 */
class GetTagTopAlbumsUsecase(repository: IDataStore) : BaseUsecase<TopAlbumEntity, RequestValue>(repository) {
