...
import taiwan.no1.app.ssfm.models.usecases.GetTopTagsCase.RequestValue
/**
 * @author  jieyi
 * @since   10/11/17
 */
class GetTopTagsCase(repository: IDataStore) : BaseUsecase<TopTagEntity, RequestValue>(repository) {
