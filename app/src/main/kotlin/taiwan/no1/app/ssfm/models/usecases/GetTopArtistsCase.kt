...
import taiwan.no1.app.ssfm.models.usecases.GetTopArtistsCase.RequestValue
/**
 * @author  jieyi
 * @since   10/11/17
 */
class GetTopArtistsCase(repository: IDataStore) : BaseUsecase<TopArtistEntity, RequestValue>(repository) {
