...
import taiwan.no1.app.ssfm.models.usecases.v2.GetHotPlaylistCase.RequestValue

/**
 * @author  jieyi
 * @since   11/21/17
 */
class GetHotPlaylistCase(repository: IDataStore) : BaseUsecase<HotPlaylistEntity, RequestValue>(repository) {
