...
import taiwan.no1.app.ssfm.models.usecases.GetTopTracksUsecase.RequestValue

/**
 * @author  jieyi
 * @since   10/11/17
 */
class GetTopTracksUsecase(repository: IDataStore) : BaseUsecase<TopTrackEntity, RequestValue>(repository) {
