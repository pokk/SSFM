...
import taiwan.no1.app.ssfm.models.usecases.GetTagTopArtistsCase.RequestValue

/**
 * @author  jieyi
 * @since   10/26/17
 */
class GetTagTopArtistsCase(repository: IDataStore) : BaseUsecase<TagTopArtistEntity, RequestValue>(repository) {
