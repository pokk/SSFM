...
public class Event implements Serializable {
    ...
    public Event(int id, String title, String[] artists, String headliner, Venue venue, Date startDate, Date endDate,
                 String description, ImageUrl[] images, int attendance, int reviews, String tag, String url,
                 String status, HashMap<String, String> ticketUrls, String score, String[] friends) {
        super();
        this.id = id;
        this.title = title;
